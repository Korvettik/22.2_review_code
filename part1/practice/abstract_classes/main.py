...
class Boat(Transport):
    def start_engine(self):
        print('Санни Крокет повернул ключ и его скарабей провернул валы')

    def stop_engine(self):
        print('Санни Крокет вынул ключ и его скарабей пустил дыму')

    def move(self):
        print('Скарабей, разрезая волну, уходит за горизонт')

    def stop(self):
        print('Скарабей, штиль, герлз')


class Car(Transport):
    def start_engine(self):
        print('Дайтона взревела, гремя поршнями')

    def stop_engine(self):
        print('Дайтона стоит')

    def move(self):
        print('Дайтона ураганит по улицам Майами')

    def stop(self):
        print('Дайтона остыла, пляж, герлз')


class Electroscooter(Transport):
    def start_engine(self):
        print('Тестаросса подняла фары')

    def stop_engine(self):
        print('Тестаросса убрала фары')

    def move(self):
        print('Тестаросса в погоне за Лаборгини')

    def stop(self):
        print('Тестаросса остыла, пляж, герлз')
