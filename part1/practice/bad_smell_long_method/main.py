...
def filtr_by_age(_new_data):
    # Фильтрация
    res = [data for data in _new_data if data['age'] > 10]
    return res
...
if __name__ == '__main__':
    ...
    data = get_data_from_string(csv)
    _new_data = sort_by_age(data)
    result_data = filtr_by_age(_new_data)
    print(result_data)
